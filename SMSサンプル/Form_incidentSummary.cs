...
namespace SMSサンプル
{
    public partial class Form_incidentSummary : Form
    {
        ...
        {
            this.m_intervaltime.Text = incidentdt.interval;
        ...
        private void m_host_List_DoubleClick(object sender, EventArgs e)
        {
            ...
            incidentdt.interval = this.m_incidentList.Items[item[0]].SubItems[0].Text;

            incidentdt.incident_no = this.m_incidentList.Items[item[0]].SubItems[1].Text;
            if (this.m_incidentList.Items[item[0]].SubItems[2].Text == "完了")
                incidentdt.status = "0";
            else if (this.m_incidentList.Items[item[0]].SubItems[2].Text == "未完了")
                incidentdt.status = "1";
            else
                incidentdt.status = "";

            incidentdt.mpms_incident = this.m_incidentList.Items[item[0]].SubItems[3].Text;
            incidentdt.s_cube_id = this.m_incidentList.Items[item[0]].SubItems[4].Text;

            //1:アラーム検知 2:障害申告 3:問い合わせ
            if (this.m_incidentList.Items[item[0]].SubItems[5].Text == "アラーム検知")
                incidentdt.incident_type = "1";
            else if (this.m_incidentList.Items[item[0]].SubItems[5].Text == "障害申告")
                incidentdt.incident_type = "2";
            else if (this.m_incidentList.Items[item[0]].SubItems[5].Text == "問い合わせ")
                incidentdt.incident_type = "3";
            else
                incidentdt.incident_type = "";


            incidentdt.content = this.m_incidentList.Items[item[0]].SubItems[6].Text;
            if (this.m_incidentList.Items[item[0]].SubItems[7].Text == "無")
                incidentdt.matflg = "0";
            else if (this.m_incidentList.Items[item[0]].SubItems[7].Text == "有")
                incidentdt.matflg = "1";
            else
                incidentdt.matflg = "";
            ...
            incidentdt.matcommand = this.m_incidentList.Items[item[0]].SubItems[8].Text;
            incidentdt.uketukedate = this.m_incidentList.Items[item[0]].SubItems[9].Text;
            incidentdt.tehaidate = this.m_incidentList.Items[item[0]].SubItems[10].Text;
            incidentdt.fukyudate = this.m_incidentList.Items[item[0]].SubItems[11].Text;
            incidentdt.enddate = this.m_incidentList.Items[item[0]].SubItems[12].Text;
            incidentdt.timer = this.m_incidentList.Items[item[0]].SubItems[13].Text;
            incidentdt.kakuninmsg = this.m_incidentList.Items[item[0]].SubItems[14].Text;
        
            incidentdt.userno = this.m_incidentList.Items[item[0]].SubItems[15].Text;
            incidentdt.systemno = this.m_incidentList.Items[item[0]].SubItems[16].Text;
            incidentdt.siteno = this.m_incidentList.Items[item[0]].SubItems[17].Text;
            incidentdt.hostno = this.m_incidentList.Items[item[0]].SubItems[18].Text;
            incidentdt.chk_date = this.m_incidentList.Items[item[0]].SubItems[19].Text;
            incidentdt.chk_name_id = this.m_incidentList.Items[item[0]].SubItems[20].Text;
